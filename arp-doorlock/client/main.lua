...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('arp-doorlock:getDoorInfo', function(doorInfo, count)
...
RegisterNetEvent('arp-doorlock:currentlyhacking')
AddEventHandler('arp-doorlock:currentlyhacking', function(mycb)
			mycb = true
				...
				if  IsControlJustReleased(1,  38) and isAuthorized then
					...
					if doorID.locked == true then
                        ...
                        while active do
                            ...
                            DrawText3DTest(doorID.textCoords, "~g~UNLOCKING~s~", size)
                    ...
                    elseif doorID.locked == false then
                        ...
                        while active do
                            Citizen.Wait(1)
                            DrawText3DTest(doorID.textCoords, "~r~LOCKING~s~", size)
                            swingcount = swingcount + 1
					...
					TriggerServerEvent('arp-doorlock:updateState', i, doorID.locked)
				end
...
RegisterNetEvent('arp-doorlock:setState')
AddEventHandler('arp-doorlock:setState', function(doorID, state)
