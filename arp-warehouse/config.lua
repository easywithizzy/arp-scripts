...
Config.blackmoney = true -- set true if you want to pay with blackmoney
Config.itemmultiplier = 1.5 -- set this for make items single sell price
Config.bonus = 20.0 -- Higher values makes bonus sell price lower // DO NOT SET LOWER THAN 1 !!!
...
Config.Price = {
    s1_1 = math.random(3000, 4000),
    s1_2 = math.random(2000, 3000),
    s2_1 = math.random(1000, 1100),
    s2_2 = math.random(1200, 2000),
    s3_1 = math.random(2000, 3000),
    s3_2 = math.random(3000, 3100),
    s4_1 = math.random(3200, 2000),
    s4_2 = math.random(2000, 3000),
    s5_1 = math.random(3000, 3100),
    s5_2 = math.random(3200, 3400),
    s6_1 = math.random(3000, 3100),
    s6_2 = math.random(2000, 3000),
}